...
public class BusinessAboutMe extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_business_about_me);
        if (NavUtils.getParentActivityName(BusinessAboutMe.this) != null) {
    ...
    private Element createCopyright()
    {
        ...
        copyright.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(BusinessAboutMe.this,copyrightString,Toast.LENGTH_SHORT).show();
            }
        });
        return copyright;
    }
